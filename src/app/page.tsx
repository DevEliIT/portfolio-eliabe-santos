      ...
      <main className="flex-1">
        ...
        >
          ...
          <div className="relative max-w-4xl">
            ...
            <a
              href="#sobre"
              className="inline-flex items-center gap-2 text-xs font-bold tracking-widest uppercase px-7 py-3 rounded-full border transition-all hover:bg-white/10"
        ...
        {/* SOBRE SECTION */}
        <section id="sobre" className="flex flex-col md:flex-row min-h-[60vh]">
          {/* Left white */}
          <div className="flex-1 bg-white flex flex-col justify-center px-8 md:px-16 py-16">
            <div
          ...
          >
            ...
            <Link
              href="/projects"
              className="self-start text-xs font-bold tracking-widest uppercase px-6 py-2.5 rounded-full border border-white text-white hover:bg-white hover:text-[#e84040] transition-all"
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              Ver Meus Projetos
            </Link>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              {projects.slice(0, 4).map((item) => (
                <Link
                  ...
                  className="relative overflow-hidden rounded group cursor-pointer block"
                  style={{ aspectRatio: "1" }}
                >
                  <Image
                    src={item.coverImg}
