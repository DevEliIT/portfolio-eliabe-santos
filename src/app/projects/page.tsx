    ...
    <div className="min-h-screen bg-[#1e2235] text-white flex flex-col font-sans" style={{ fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <main className="flex-1 pt-28 pb-20 px-8 md:px-20 max-w-6xl mx-auto w-full">
        ...
        {loading ? (
          ...
          <motion.section layout className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <AnimatePresence>
              {filteredProjects.map((project) => (
                ...
                >
                  <Link
                    ...
                    className="group relative flex flex-col bg-white/[0.02] rounded-xl overflow-hidden border border-white/10 hover:border-[#e84040]/50 transition-all duration-300 shadow-lg h-full"
                  >
                    {/* Image Banner */}
